                                        ...
                                        <form class="needs-validation" method="POST" action="{{ route('pickups.update', $pickup->id) }}" novalidate>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label for="product_item_no" class="form-label">Product Number</label>
                                                        <input type="number" class="form-control" name="product_item_no" id="product_item_no" placeholder="Product Number" value="{{ old('product_item_no', $pickup->product_item_no) }}" required>
